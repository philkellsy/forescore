...
function buildContent({ firstName, tourLabel, tenantName, inviterName, loginUrl }) {
  ...
  const body = `
    ...
    <p style="margin:0 0 20px;color:#4a5568;">
      ForeScore is a mobile-first golf tour app. During the tour you'll be able to:
    </p>

    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 24px;">
      <tr>
        <td style="padding:8px 0;vertical-align:top;width:28px;font-size:18px;">⛳</td>
        <td style="padding:8px 0;vertical-align:top;font-size:15px;color:#2d3748;">Enter your scores hole-by-hole from your phone — even offline.</td>
      </tr>
      <tr>
        <td style="padding:8px 0;vertical-align:top;width:28px;font-size:18px;">🏆</td>
        <td style="padding:8px 0;vertical-align:top;font-size:15px;color:#2d3748;">Follow the leaderboard in real time.</td>
      </tr>
      <tr>
        <td style="padding:8px 0;vertical-align:top;width:28px;font-size:18px;">📅</td>
        <td style="padding:8px 0;vertical-align:top;font-size:15px;color:#2d3748;">View the full tour itinerary — tee times, meals, accommodation and more.</td>
      </tr>
    </table>
